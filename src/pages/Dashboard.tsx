...
import { PersonaDashboardRedirect } from "@/components/navigation/PersonaDashboardRedirect";
...
export const Dashboard = () => {
  ...
  // If user is authenticated, redirect to their persona dashboard
  if (user) {
    return <PersonaDashboardRedirect />;
  }
