...
export const EnhancedTAMappingInterface: React.FC<EnhancedTAMappingInterfaceProps> = ({
  ...
  const [activeView, setActiveView] = useState<'overview' | 'workload' | 'assignments'>('overview');
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between text-xs text-gray-500">
                            <span>Success Rate: {ta.success_rate}%</span>
                            <span>Efficiency: {ta.efficiency_score}</span>
                          </div>
                        </div>
                      </div>
                    );
                ...
                {selectedTA ? (
                  <RoleAssignmentPanel 
                    ...
                    onAssignmentUpdate={(assignmentId, updates) => {
                      console.log('Update assignment:', assignmentId, updates);
                    }}
                  />
                ) : (
